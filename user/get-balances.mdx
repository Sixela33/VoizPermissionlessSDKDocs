...
You want live USDC (and other ERC-20 balances) in a wallet, from the chain. These are not remaining Yes/No on the indexer and not liquidity lots. They live on the client, not on the user handle.
